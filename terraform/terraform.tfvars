...
# 이 파일을 terraform.tfvars로 복사하고 자신의 환경에 맞게 수정하세요.
...
# 2. 도메인 등록 업체에서 NS 레코드를 Route53 값으로 변경
# 3. ACM에서 인증서 생성:
#    - CloudFront용: us-east-1 리전에서 생성
#    - ALB용: ap-northeast-3 리전에서 생성
# 4. DNS 검증 완료 후 인증서 ARN을 위에 입력
